...
// ============================================================
// E-Mail Service via email_queue Tabelle
//
// Alle Mails werden in email_queue gespeichert.
// Für Produktion: Supabase Edge Function "send-email" aktivieren
// (siehe supabase/resend-function.sql für Anleitung).
//
...
export async function sendEmail(
  ...
  if (error) {
    // Fehler nur loggen, nicht crashen — E-Mail ist kein kritischer Pfad
    console.warn("[emailService] Fehler beim Speichern in email_queue:", error.message);
    return false;
  }
  return true;
}
...
<ul>
  ...
  <li><strong>Bewertung:</strong> ${rating}/5 Sterne</li>
