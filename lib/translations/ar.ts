...
const ar: Record<TranslationKeys, string> = {
  ...
  // Questionnaire
  "questionnaire.section1Title": "الانطباع العام",
  "questionnaire.section2Title": "الإرشاد والمحتوى",
  "questionnaire.section3Title": "العلاقة مع المرشد",
  "questionnaire.section4Title": "التحسينات والأمنيات",
  "questionnaire.section5Title": "ملاحظات ختامية",
  "questionnaire.q1_1": "ما مدى رضاك عن الإرشاد بشكل عام؟",
  "questionnaire.q1_2": "ما السبب الأهم لتقييمك؟",
  "questionnaire.q1_3": "ما مدى جودة دعم مرشدك لك؟",
  "questionnaire.q2_1": "هل شعرت أن أسئلتك أُخذت على محمل الجد وتمت الإجابة عليها؟",
  "questionnaire.q2_2": "في أي مجالات كنت تتمنى المزيد من الدعم؟",
  "questionnaire.q2_2b": "يُرجى التوضيح إذا اخترت \"أخرى\"",
  "questionnaire.q3_1": "كيف كانت علاقتك الشخصية بمرشدك؟",
  "questionnaire.q3_2": "ما الذي أعجبك بشكل خاص في العلاقة أو ما كان صعبًا؟",
  "questionnaire.q3_3": "هل شعرت بالتشجيع والقوة من خلال الإرشاد؟",
  "questionnaire.q4_1": "ما الذي أعجبك بشكل خاص في الإرشاد؟",
  "questionnaire.q4_2": "ما الذي يمكن تحسينه مستقبلاً؟",
  "questionnaire.q4_2b": "يُرجى التوضيح إذا اخترت \"أخرى\"",
  "questionnaire.q4_3": "هل ترغب في البقاء على تواصل مع المجتمع أو مرشدك بعد انتهاء البرنامج؟",
  "questionnaire.q4_4": "ما وضعك الحالي في الإرشاد؟",
  "questionnaire.q4_5": "إذا أردت، صِف بإيجاز سبب إنهائك للإرشاد مبكرًا.",
  "questionnaire.q5_1": "هل لديك ملاحظات أو أمنيات أخرى تودّ مشاركتها؟",
  "questionnaire.q2_2_gebet": "الصلاة",
  "questionnaire.q2_2_koran": "القرآن",
  "questionnaire.q2_2_glaubenslehre": "العقيدة",
  "questionnaire.q2_2_gemeinschaft": "المجتمع",
  "questionnaire.q2_2_alltagsfragen": "أسئلة يومية",
  "questionnaire.q2_2_andere": "أخرى",
  "questionnaire.q4_2_mehr_treffen": "المزيد من اللقاءات",
  "questionnaire.q4_2_bessere_erreichbarkeit": "سهولة أكبر في التواصل",
  "questionnaire.q4_2_mehr_struktur": "المزيد من التنظيم",
  "questionnaire.q4_2_mehr_praxis": "المزيد من التطبيق العملي",
  "questionnaire.q4_2_andere": "أخرى",
  "questionnaire.q4_3_ja_sehr_gerne": "نعم، بكل سرور",
  "questionnaire.q4_3_vielleicht": "ربما",
  "questionnaire.q4_3_nein_danke": "لا، شكرًا",
  "questionnaire.q4_4_noch_in_betreuung": "لا يزال في الإرشاد",
  "questionnaire.q4_4_erfolgreich_abgeschlossen": "أُنجز بنجاح",
  "questionnaire.q4_4_vorzeitig_beendet": "أُنهي مبكرًا",
  "questionnaire.progress": "القسم {0} من {1}",
  "questionnaire.next": "التالي",
  "questionnaire.back": "رجوع",
  "questionnaire.submit": "إرسال التقييم",
  "questionnaire.summary": "ملخص",
  "questionnaire.summaryHint": "يُرجى مراجعة إجاباتك قبل الإرسال.",
  "questionnaire.errorRequired": "هذا الحقل مطلوب.",
  "questionnaire.errorSelectOne": "يُرجى اختيار خيار واحد على الأقل.",
  "questionnaire.showDetails": "عرض التفاصيل",
  "questionnaire.hideDetails": "إخفاء التفاصيل",
  "questionnaire.noAnswer": "لا توجد إجابة",
  ...
  "chat.templates": "القوالب",
  "chat.templateBrother": "أخي",
  "chat.templateSister": "أختي",
  "templates.manage": "قوالب الرسائل",
  "templates.manageDesc": "قوالب للمرشدين في المحادثة",
  "templates.hint": "العناصر النائبة: {{NAME}}، {{ANREDE}} (أخي/أختي)، {{MENTOR_NAME}}",
  "templates.titleLabel": "العنوان",
  "templates.titlePlaceholder": "مثال: أول تواصل",
  "templates.categoryLabel": "الفئة",
  "templates.bodyLabel": "نص الرسالة",
  "templates.bodyPlaceholder": "أدخل نص القالب...",
  "templates.placeholderHint": "استخدم {{NAME}}، {{ANREDE}}، {{MENTOR_NAME}} كعناصر نائبة",
  "templates.saved": "تم حفظ القالب.",
  "templates.deleted": "تم حذف القالب.",
  "templates.errorEmpty": "العنوان والنص لا يمكن أن يكونا فارغين.",
  "templates.deleteTitle": "حذف القالب",
  "templates.deleteConfirm": "هل أنت متأكد أنك تريد حذف هذا القالب؟",
  ...
  "settings.accountDeleted": "تم حذف حسابك بنجاح. سيتم تسجيل خروجك الآن.",
