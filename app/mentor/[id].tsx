...
const styles = StyleSheet.create({
  ...
  menteeAvatarText: { color: COLORS.white, fontWeight: "800", fontSize: 14 },
  menteeInfo: { flex: 1 },
  menteeName: { fontWeight: "800", fontSize: 14 },
  ...
  editProfileButtonText: { color: COLORS.white, fontWeight: "800", fontSize: 14 },
});
