...
const styles = StyleSheet.create({
  ...
  hadithHeader: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 12 },
  ...
  hadithText: { fontSize: 14, lineHeight: 22, marginBottom: 8, fontStyle: "italic" },
  hadithSource: { fontSize: 12, marginBottom: 12 },
  hadithActions: { flexDirection: "row", alignItems: "center", gap: 8, flexWrap: "wrap" },
  hadithNextBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
