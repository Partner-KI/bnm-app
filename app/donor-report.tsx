...
const styles = StyleSheet.create({
  ...
  reportTitle: { color: COLORS.white, fontSize: 20, fontWeight: "800", textAlign: "center", marginBottom: 4 },
  ...
  sectionHeaderText: { color: COLORS.white, fontWeight: "800", fontSize: 13 },
  ...
  statusBarValue: { color: COLORS.white, fontWeight: "800", fontSize: 16 },
  ...
  hBarCount: { fontWeight: "800", fontSize: 13, minWidth: 24, textAlign: "right" },
