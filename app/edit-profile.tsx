...
const styles = StyleSheet.create({
  ...
  contactChipTextActive: { color: COLORS.white, fontWeight: "600", fontSize: 14 },
  contactChipTextInactive: { color: COLORS.secondary, fontWeight: "500", fontSize: 14 },
  infoBox: {
  ...
  cancelButtonText: { color: COLORS.secondary, fontWeight: "500", fontSize: 15 },
});
