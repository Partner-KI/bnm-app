...
const styles = StyleSheet.create({
  ...
  toggleTitle: { fontWeight: "600", color: COLORS.primary, fontSize: 15 },
  toggleSubtitle: { color: COLORS.tertiary, fontSize: 13, marginTop: 2 },
  languageRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  languageLabel: { color: COLORS.primary, fontSize: 15 },
  checkMark: {
    width: 24,
    height: 24,
    borderRadius: 12,
  ...
  infoLabel: { color: COLORS.secondary, fontSize: 15 },
  infoValue: { color: COLORS.primary, fontSize: 14, fontWeight: "500" },
  privacyText: {
